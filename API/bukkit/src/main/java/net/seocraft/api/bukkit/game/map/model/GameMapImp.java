...
public class GameMapImp implements GameMap {
    ...
    public GameMapImp(@NotNull String id, @NotNull String name, @NotNull String file, @NotNull String configuration, @NotNull String image, @NotNull String author, @NotNull String version, @NotNull Set<Contribution> contributors, @NotNull String gamemode, @NotNull String subGamemode, @NotNull String description, @NotNull Set<Rating> rating, long registeredDate) {
        this.id = id;
        this.name = name;
        this.file = file;
