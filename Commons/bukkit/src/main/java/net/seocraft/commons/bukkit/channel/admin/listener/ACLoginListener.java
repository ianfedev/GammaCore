...
public class ACLoginListener implements ChannelListener<User> {

    @NotNull private ACLoginBroadcaster broadcaster;
    @NotNull private UserPermissionChecker userPermissionChecker;

    public ACLoginListener(@NotNull ACLoginBroadcaster loginBroadcaster, @NotNull UserPermissionChecker userPermissionChecker) {
    ...
    public void receiveMessage(User object) {
        ...
        this.broadcaster.broadcastLogin(
                object,
                hasPermission
        );
