...
public class BridgedUserBan {
    ...
    public static void banPlayer(Channel<UserExpulsion> expulsionChannel, Punishment punishment, User targetData) {
        expulsionChannel.sendMessage(new PlayerExpulsion(targetData, punishment.getReason(), punishment.getExpiration(), punishment.isPermanent(), punishment.getType() == PunishmentType.KICK));
    }
}
